...
namespace Frequencytest.Logger
{
	...
	public class EEG_Logger
	{
		...
		public void Run()
		{
			...
			data[EdkDll.EE_DataChannel_t.O1] = sn.HighPassFilter(data[EdkDll.EE_DataChannel_t.O1], 0.16f);
			data[EdkDll.EE_DataChannel_t.O2] = sn.HighPassFilter(data[EdkDll.EE_DataChannel_t.O2], 0.16f);
